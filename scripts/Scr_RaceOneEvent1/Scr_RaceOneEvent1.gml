...
function Scr_RaceOneEventOne() {
	...
	switch (eventMenuPos)
	{
		case 0:
		{		
			if global.currBudget - 500000000 < 0 global.currBudget = 0;
			else global.currBudget -= 500000000;
			result = "Case 0";
			break;
		}
		case 1:
